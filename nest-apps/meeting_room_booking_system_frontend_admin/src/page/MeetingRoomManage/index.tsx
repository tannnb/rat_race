...
import { Button, message, Popconfirm, Form, Typography, Space } from 'antd'
import { PlusOutlined } from '@ant-design/icons'
import type { CreateRoom } from '../../interfaces'
...
const MeetingRoomManage: React.FC = () => {
  const actionRef = useRef<ActionType>()
  const [form] = Form.useForm<CreateRoom>()
      ...
      render: (text, record, _, action) => {
        return (
          <Space>
            ...
            <Popconfirm
              title="是否删除该会议室"
              onConfirm={() => handleRemoveRoom(record.id)}
              okText="确定"
              cancelText="取消"
            >
              <Link>删除</Link>
